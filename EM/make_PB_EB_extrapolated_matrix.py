...
def write_combined_cons(continuous = False, fname = 'extrapolated/PB_EB_extrapolated', shift = 0, regular_D7s = False):
    '''
    extrapolate mean connectivity data in the EB and PB to form
    an extrapolated approximate connectivity matrix for the full circuit
    '''
    ...
    #load connections for the EB
    consEB = pickle.load( open('extrapolated/avg_connections_EB_pickled', 'rb') )
    
    #manually apply wedge numbers to the different neurons
        ...
        for g2 in groups:
            for n1 in mod.groups[g1]:
                for n2 in mod.groups[g2]:
                    if n1!=n2:
                        try:
                            if 'R' in g1 and 'R' in g2: #don't consider ring-ring connections
                                continue
                            elif 'R' in g2:
...
if __name__ == '__main__':
    ...
    #get average connectivities for the EB
    ...
    #get average connectivities for the PB
